            ...
            <div className="navbar bg-black text-white">
                <div className="navbar-start">
                    <div className="dropdown bg-black">
                        ...
                        <ul tabindex="0" className="bg-black text-white menu menu-compact dropdown-content mt-3 p-2 shadow rounded-box w-52">
                            ...
                            <li><Link to='/dashboard' className=' ml-20 hover:text-orange-300 uppercase font-thin'>
                            Cart</Link></li>
                ...
                <div className="navbar-end hidden lg:flex">
                    <ul className="menu menu-horizontal p-0">
                        <li><Link to='/dashboard' className='ml-20 hover:text-orange-300 uppercase font-thin'>Cart</Link></li>
