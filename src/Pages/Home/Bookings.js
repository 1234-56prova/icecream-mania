    ...
    return (
        <div className='lg:flex mt-32 m-16 glass border rounded-none'>
            ...
            <div className='m-10 lg:w-1/2'>
                ...
                <input type="text" placeholder="4 person" width='300px' class="input glass w-full m-3 lg:m-5" /><br />
                <input type="date" placeholder="7,22,2022" class="input glass w-full m-3 lg:m-5" /><br />
                <input type="email" placeholder="Email" class="input glass w-full m-3 lg:m-5" />
                <button class="btn bg-orange-200 m-3 lg:ml-56 btn-wide">BOOK A TABLE</button>
            </div>
        </div>
    );
};
